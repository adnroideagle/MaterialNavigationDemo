...
/**
 * An improved version of DrawerLayout that will ensure that a locked open
 * DrawerLayout can be used without capturing all touches into the client area.
 * <p>
 * To activate, call {@link #requestDisallowInterceptTouchEvent(boolean)} on the
 * layout. Note that this should only ever be done in case when the drawer is to
 * be locked open.
 * </p>
 *
